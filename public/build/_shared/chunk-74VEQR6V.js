...
var require_baseIsNative = __commonJS({
  "node_modules/lodash/_baseIsNative.js"(exports, module) {
    var isFunction18 = require_isFunction();
    ...
    function baseIsNative(value) {
      ...
      var pattern = isFunction18(value) ? reIsNative : reIsHostCtor;
...
var require_isArrayLike = __commonJS({
  "node_modules/lodash/isArrayLike.js"(exports, module) {
    ...
    function isArrayLike(value) {
      return value != null && isLength(value.length) && !isFunction18(value);
    }
...
var require_sortBy = __commonJS({
  "node_modules/lodash/sortBy.js"(exports, module) {
    ...
    var sortBy4 = baseRest(function(collection2, iteratees) {
      if (collection2 == null) {
        return [];
      }
...
var require_map = __commonJS({
  "node_modules/lodash/map.js"(exports, module) {
    ...
    var baseMap = require_baseMap();
    var isArray2 = require_isArray();
    function map3(collection2, iteratee) {
      var func = isArray2(collection2) ? arrayMap : baseMap;
      return func(collection2, baseIteratee(iteratee, 3));
    }
    module.exports = map3;
  }
});
...
var require_flatMap = __commonJS({
  "node_modules/lodash/flatMap.js"(exports, module) {
    ...
    function flatMap2(collection2, iteratee) {
      return baseFlatten(map3(collection2, iteratee), 1);
    }
...
var require_some = __commonJS({
  "node_modules/lodash/some.js"(exports, module) {
    ...
    function some2(collection2, predicate, guard) {
      ...
      return func(collection2, baseIteratee(predicate, 3));
    }
...
var require_every = __commonJS({
  "node_modules/lodash/every.js"(exports, module) {
    ...
    var isArray2 = require_isArray();
    var isIterateeCall = require_isIterateeCall();
    function every3(collection2, predicate, guard) {
...
var useBudgets = () => {
  ...
  (0, import_react.useEffect)(() => {
    ...
    const unsubscribe = onSnapshot(budgetCollection, (snapshot) => {
      ...
      const sortedBudgets = budgetsData.sort((a2, b) => {
        const dateA = a2.createdAt.toMillis();
  ...
  const addBudget = async (newBudget) => {
    try {
      const budgetCollection = collection(db, `users/${user?.uid}/budgets`);
      const docRef = await addDoc(budgetCollection, { ...newBudget, userId: user?.uid });
...
var useBudgets_default = useBudgets;

// app/components/budgets/budgetsChart.tsx
...
function Surface(props) {
  ...
  return /* @__PURE__ */ import_react4.default.createElement("svg", _extends2({}, filterProps(others, true, "svg"), {
...
var Layer = /* @__PURE__ */ import_react5.default.forwardRef(function(props, ref) {
  ...
  return /* @__PURE__ */ import_react5.default.createElement("g", _extends3({
    className: layerClass
...
var Symbols = function Symbols2(_ref) {
  ...
  if (cx === +cx && cy === +cy && size === +size) {
    return /* @__PURE__ */ import_react6.default.createElement("path", _extends4({}, filteredProps, {
  ...
  _createClass(DefaultLegendContent2, [{
    ...
    value: function renderItems() {
      ...
      return payload.map(function(entry, i) {
        ...
        return /* @__PURE__ */ import_react7.default.createElement("li", _extends5({
          className,
          style: itemStyle,
...
var DefaultTooltipContent = function DefaultTooltipContent2(props) {
  ...
  return /* @__PURE__ */ import_react9.default.createElement("div", _extends6({
    className: wrapperCN,
    style: finalStyle
...
var DecimalCSS = /* @__PURE__ */ function() {
  ...
  _createClass5(DecimalCSS2, [{
    ...
    value: function parse(str) {
      ...
      var _ref = (_NUM_SPLIT_REGEX$exec = NUM_SPLIT_REGEX.exec(str)) !== null && _NUM_SPLIT_REGEX$exec !== void 0 ? _NUM_SPLIT_REGEX$exec : [], _ref2 = _slicedToArray2(_ref, 3), numStr = _ref2[1], unit2 = _ref2[2];
...
function calculateArithmetic(expr) {
  ...
  while (newExpr.includes("*") || newExpr.includes("/")) {
    ...
    var _ref3 = (_MULTIPLY_OR_DIVIDE_R = MULTIPLY_OR_DIVIDE_REGEX.exec(newExpr)) !== null && _MULTIPLY_OR_DIVIDE_R !== void 0 ? _MULTIPLY_OR_DIVIDE_R : [], _ref4 = _slicedToArray2(_ref3, 4), leftOperand = _ref4[1], operator = _ref4[2], rightOperand = _ref4[3];
  ...
  while (newExpr.includes("+") || /.-\d+(?:\.\d+)?/.test(newExpr)) {
    ...
    var _ref5 = (_ADD_OR_SUBTRACT_REGE = ADD_OR_SUBTRACT_REGEX.exec(newExpr)) !== null && _ADD_OR_SUBTRACT_REGE !== void 0 ? _ADD_OR_SUBTRACT_REGE : [], _ref6 = _slicedToArray2(_ref5, 4), _leftOperand = _ref6[1], _operator = _ref6[2], _rightOperand = _ref6[3];
...
var Text2 = function Text3(_ref5) {
  ...
  return /* @__PURE__ */ import_react12.default.createElement("text", _extends7({}, filterProps(textProps, true), {
    x: x2,
    y: y2,
...
function ErrorBar(props) {
  ...
  var errorBars = data.map(function(entry) {
    ...
    return /* @__PURE__ */ import_react13.default.createElement(Layer, _extends8({
      className: "recharts-errorBar",
      key: "bar-".concat(lineCoordinates.map(function(c2) {
        return "".concat(c2.x1, "-").concat(c2.x2, "-").concat(c2.y1, "-").concat(c2.y2);
      }))
    }, svgProps), lineCoordinates.map(function(coordinates) {
      return /* @__PURE__ */ import_react13.default.createElement("line", _extends8({}, coordinates, {
...
var formatAxisMap = function formatAxisMap2(props, axisMap, offset, axisType, chartName) {
  ...
  return ids.reduce(function(result, id) {
    ...
    if ((0, import_isNil5.default)(axis.range)) {
      ...
      range6 = axis.range;
      var _range = range6;
      var _range2 = _slicedToArray6(_range, 2);
    ...
    var ticks2 = getTicksOfScale(scale, _objectSpread10(_objectSpread10({}, axis), {}, {
      realScaleType
    }));
    var finalAxis = _objectSpread10(_objectSpread10(_objectSpread10({}, axis), ticks2), {}, {
      range: range6,
      radius: outerRadius,
      realScaleType,
      scale,
    ...
    return _objectSpread10(_objectSpread10({}, result), {}, _defineProperty11({}, id, finalAxis));
  }, {});
};
...
var renderRadialLabel = function renderRadialLabel2(labelProps, label, attrs) {
  ...
  return /* @__PURE__ */ import_react15.default.createElement("text", _extends9({}, attrs, {
...
function Label(_ref4) {
  ...
  return /* @__PURE__ */ import_react15.default.createElement(Text2, _extends9({
...
var parseLabel = function parseLabel2(label, viewBox) {
  ...
  if ((0, import_isObject3.default)(label)) {
    return /* @__PURE__ */ import_react15.default.createElement(Label, _extends9({
      viewBox
    }, label, {
      key: "label-implicit"
    }));
...
function LabelList(_ref) {
  ...
  return /* @__PURE__ */ import_react16.default.createElement(Layer, {
    ...
    return /* @__PURE__ */ import_react16.default.createElement(Label, _extends10({}, filterProps(entry, true), others, idProps, {
      parentViewBox: entry.parentViewBox,
      value,
      textBreakAll,
      viewBox: Label.parseViewBox((0, import_isNil7.default)(clockWise) ? entry : _objectSpread12(_objectSpread12({}, entry), {}, {
        clockWise
      })),
      key: "label-".concat(index),
      index
...
function parseLabelList(label, data) {
  ...
  if ((0, import_isObject4.default)(label)) {
    return /* @__PURE__ */ import_react16.default.createElement(LabelList, _extends10({
      data
    }, label, {
      key: "labelList-implicit"
    }));
...
var Sector = function Sector2(sectorProps) {
  ...
  return /* @__PURE__ */ import_react17.default.createElement("path", _extends11({}, filterProps(props, true), {
    className: layerClass,
    d: path2,
    role: "img"
  }));
...
var Curve = function Curve2(props) {
  ...
  return /* @__PURE__ */ import_react18.default.createElement("path", _extends12({}, filterProps(props, false), adaptEventHandlers(props), {
  ...
  _createClass6(Animate2, [{
    ...
    value: function render() {
      ...
      var cloneContainer = function cloneContainer2(container) {
        ...
        var res = /* @__PURE__ */ (0, import_react19.cloneElement)(container, _objectSpread17(_objectSpread17({}, others), {}, {
...
var TransitionGroup = /* @__PURE__ */ function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return /* @__PURE__ */ import_react23.default.createElement(TransitionGroupContext_default.Provider, {
      value: contextValue
    }, /* @__PURE__ */ import_react23.default.createElement(Component3, props, children));
  };
...
var Polygon = function Polygon2(props) {
  var points = props.points, className = props.className, baseLinePoints = props.baseLinePoints, connectNulls = props.connectNulls, others = _objectWithoutProperties12(props, _excluded13);
  ...
  if (baseLinePoints && baseLinePoints.length) {
    ...
    return /* @__PURE__ */ import_react27.default.createElement("g", {
      className: layerClass
    }, /* @__PURE__ */ import_react27.default.createElement("path", _extends15({}, filterProps(others, true), {
      fill: rangePath.slice(-1) === "Z" ? others.fill : "none",
      stroke: "none",
      d: rangePath
    })), hasStroke ? /* @__PURE__ */ import_react27.default.createElement("path", _extends15({}, filterProps(others, true), {
      fill: "none",
      d: getSinglePolygonPath(points, connectNulls)
    })) : null, hasStroke ? /* @__PURE__ */ import_react27.default.createElement("path", _extends15({}, filterProps(others, true), {
      fill: "none",
      d: getSinglePolygonPath(baseLinePoints, connectNulls)
    })) : null);
  }
  var singlePath = getSinglePolygonPath(points, connectNulls);
  return /* @__PURE__ */ import_react27.default.createElement("path", _extends15({}, filterProps(others, true), {
...
var Dot = function Dot2(props) {
  ...
  if (cx === +cx && cy === +cy && r2 === +r2) {
    return /* @__PURE__ */ import_react28.default.createElement("circle", _extends16({}, filterProps(props, false), adaptEventHandlers(props), {
      className: layerClass,
      cx,
      cy,
      r: r2
...
var Cross = function Cross2(_ref) {
  var _ref$x = _ref.x, x2 = _ref$x === void 0 ? 0 : _ref$x, _ref$y = _ref.y, y2 = _ref$y === void 0 ? 0 : _ref$y, _ref$top = _ref.top, top = _ref$top === void 0 ? 0 : _ref$top, _ref$left = _ref.left, left = _ref$left === void 0 ? 0 : _ref$left, _ref$width = _ref.width, width = _ref$width === void 0 ? 0 : _ref$width, _ref$height = _ref.height, height = _ref$height === void 0 ? 0 : _ref$height, className = _ref.className, rest = _objectWithoutProperties13(_ref, _excluded14);
  ...
  return /* @__PURE__ */ import_react29.default.createElement("path", _extends17({}, filterProps(props, true), {
...
var _excluded15 = ["cx", "cy", "angle", "ticks", "axisLine"];
...
var PolarRadiusAxis = /* @__PURE__ */ function(_PureComponent) {
  ...
  _createClass8(PolarRadiusAxis2, [{
    ...
    value: function renderAxisLine() {
      var _this$props3 = this.props, cx = _this$props3.cx, cy = _this$props3.cy, angle = _this$props3.angle, ticks2 = _this$props3.ticks, axisLine = _this$props3.axisLine, others = _objectWithoutProperties14(_this$props3, _excluded15);
      var extent = ticks2.reduce(function(result, entry) {
        return [Math.min(result[0], entry.coordinate), Math.max(result[1], entry.coordinate)];
      }, [Infinity, -Infinity]);
      var point0 = polarToCartesian(cx, cy, extent[0], angle);
      var point1 = polarToCartesian(cx, cy, extent[1], angle);
      var props = _objectSpread21(_objectSpread21(_objectSpread21({}, filterProps(others, false)), {}, {
        fill: "none"
      ...
      return /* @__PURE__ */ import_react30.default.createElement("line", _extends18({
    ...
    value: function renderTicks() {
      ...
      var items = ticks2.map(function(entry, i) {
        ...
        var tickProps = _objectSpread21(_objectSpread21(_objectSpread21(_objectSpread21({
          textAnchor,
    ...
    value: function renderTickItem(option, props, value) {
      ...
      if (/* @__PURE__ */ import_react30.default.isValidElement(option)) {
        tickItem = /* @__PURE__ */ import_react30.default.cloneElement(option, props);
      } else if ((0, import_isFunction9.default)(option)) {
        tickItem = option(props);
      } else {
        tickItem = /* @__PURE__ */ import_react30.default.createElement(Text2, _extends18({}, props, {
...
_defineProperty22(PolarRadiusAxis, "displayName", "PolarRadiusAxis");
_defineProperty22(PolarRadiusAxis, "axisType", "radiusAxis");
_defineProperty22(PolarRadiusAxis, "defaultProps", {
  type: "number",
  radiusAxisId: 0,
  cx: 0,
  cy: 0,
...
var PolarAngleAxis = /* @__PURE__ */ function(_PureComponent) {
  ...
  _createClass9(PolarAngleAxis2, [{
    ...
    value: function renderAxisLine() {
      ...
      var props = _objectSpread22(_objectSpread22({}, filterProps(this.props, false)), {}, {
        fill: "none"
      }, filterProps(axisLine, false));
      if (axisLineType === "circle") {
        return /* @__PURE__ */ import_react31.default.createElement(Dot, _extends19({
      ...
      return /* @__PURE__ */ import_react31.default.createElement(Polygon, _extends19({
        className: "recharts-polar-angle-axis-line"
      }, props, {
        points
      }));
    ...
    value: function renderTicks() {
      ...
      var items = ticks2.map(function(entry, i) {
        ...
        var tickProps = _objectSpread22(_objectSpread22(_objectSpread22({
          textAnchor
        }, axisProps), {}, {
          stroke: "none",
          fill: stroke
        ...
        return /* @__PURE__ */ import_react31.default.createElement(Layer, _extends19({
          ...
          key: "tick-".concat(entry.coordinate)
        }, adaptEventsOfChild(_this.props, entry, i)), tickLine && /* @__PURE__ */ import_react31.default.createElement("line", _extends19({
    ...
    value: function renderTickItem(option, props, value) {
      ...
      if (/* @__PURE__ */ import_react31.default.isValidElement(option)) {
        ...
        tickItem = /* @__PURE__ */ import_react31.default.createElement(Text2, _extends19({}, props, {
...
_defineProperty23(PolarAngleAxis, "displayName", "PolarAngleAxis");
_defineProperty23(PolarAngleAxis, "axisType", "angleAxis");
_defineProperty23(PolarAngleAxis, "defaultProps", {
  type: "category",
  angleAxisId: 0,
  scale: "auto",
  cx: 0,
...
function _slicedToArray10(arr, i) {
  return _arrayWithHoles11(arr) || _iterableToArrayLimit10(arr, i) || _unsupportedIterableToArray17(arr, i) || _nonIterableRest11();
}
...
var Trapezoid = function Trapezoid2(props) {
  var trapezoidProps = _objectSpread23(_objectSpread23({}, defaultProps4), props);
  var pathRef = (0, import_react32.useRef)();
  var _useState = (0, import_react32.useState)(-1), _useState2 = _slicedToArray10(_useState, 2), totalLength = _useState2[0], setTotalLength = _useState2[1];
  ...
  if (!isUpdateAnimationActive) {
    return /* @__PURE__ */ import_react32.default.createElement("g", null, /* @__PURE__ */ import_react32.default.createElement("path", _extends20({}, filterProps(trapezoidProps, true), {
      className: layerClass,
  ...
  return /* @__PURE__ */ import_react32.default.createElement(es6_default, {
    ...
    return /* @__PURE__ */ import_react32.default.createElement(es6_default, {
      ...
      duration: animationDuration,
      easing: animationEasing
    }, /* @__PURE__ */ import_react32.default.createElement("path", _extends20({}, filterProps(trapezoidProps, true), {
      className: layerClass,
...
function defaultPropTransformer(option, props) {
  return _objectSpread24(_objectSpread24({}, props), option);
}
...
function ShapeSelector(_ref) {
  ...
  switch (shapeType) {
    case "rectangle":
      return /* @__PURE__ */ import_react33.default.createElement(Rectangle, elementProps);
    case "trapezoid":
      return /* @__PURE__ */ import_react33.default.createElement(Trapezoid, elementProps);
    case "sector":
      return /* @__PURE__ */ import_react33.default.createElement(Sector, elementProps);
    case "symbols":
      if (isSymbolsProps(shapeType, elementProps)) {
        return /* @__PURE__ */ import_react33.default.createElement(Symbols, elementProps);
      }
      break;
    default:
      return null;
...
function Shape(_ref2) {
  var option = _ref2.option, shapeType = _ref2.shapeType, _ref2$propTransformer = _ref2.propTransformer, propTransformer = _ref2$propTransformer === void 0 ? defaultPropTransformer : _ref2$propTransformer, _ref2$activeClassName = _ref2.activeClassName, activeClassName = _ref2$activeClassName === void 0 ? "recharts-active-shape" : _ref2$activeClassName, isActive = _ref2.isActive, props = _objectWithoutProperties15(_ref2, _excluded16);
  var shape;
  if (/* @__PURE__ */ (0, import_react33.isValidElement)(option)) {
    shape = /* @__PURE__ */ (0, import_react33.cloneElement)(option, _objectSpread24(_objectSpread24({}, props), getPropsFromShapeOption(option)));
    ...
    shape = /* @__PURE__ */ import_react33.default.createElement(ShapeSelector, {
      shapeType,
...
var Pie = /* @__PURE__ */ function(_PureComponent) {
  ...
  function Pie2(props) {
    ...
    _defineProperty26(_assertThisInitialized10(_this), "pieRef", null);
    _defineProperty26(_assertThisInitialized10(_this), "sectorRefs", []);
    _defineProperty26(_assertThisInitialized10(_this), "id", uniqueId("recharts-pie-"));
    _defineProperty26(_assertThisInitialized10(_this), "handleAnimationEnd", function() {
    ...
    _defineProperty26(_assertThisInitialized10(_this), "handleAnimationStart", function() {
  ...
  _createClass10(Pie2, [{
    ...
    value: function renderLabels(sectors) {
      ...
      var labels = sectors.map(function(entry, i) {
        ...
        var labelProps = _objectSpread25(_objectSpread25(_objectSpread25(_objectSpread25({}, pieProps), entry), {}, {
          stroke: "none"
        }, customLabelProps), {}, {
          index: i,
          textAnchor: Pie2.getTextAnchor(endPoint.x, entry.cx)
        }, endPoint);
        var lineProps = _objectSpread25(_objectSpread25(_objectSpread25(_objectSpread25({}, pieProps), entry), {}, {
          fill: "none",
          stroke: entry.fill
        ...
        return (
          // eslint-disable-next-line react/no-array-index-key
          /* @__PURE__ */ import_react34.default.createElement(Layer, {
    ...
    value: function renderSectorsStatically(sectors) {
      ...
      return sectors.map(function(entry, i) {
        ...
        var sectorProps = _objectSpread25(_objectSpread25({}, entry), {}, {
          stroke: blendStroke ? entry.fill : entry.stroke,
          tabIndex: -1
        });
        return /* @__PURE__ */ import_react34.default.createElement(Layer, _extends21({
        ...
        }), /* @__PURE__ */ import_react34.default.createElement(Shape, _extends21({
      ...
      return /* @__PURE__ */ import_react34.default.createElement(es6_default, {
        ...
        sectors.forEach(function(entry, index) {
          ...
          if (prev) {
            ...
            var latest = _objectSpread25(_objectSpread25({}, entry), {}, {
            ...
            var _latest = _objectSpread25(_objectSpread25({}, entry), {}, {
              startAngle: curAngle + paddingAngle,
        ...
        return /* @__PURE__ */ import_react34.default.createElement(Layer, null, _this3.renderSectorsStatically(stepData));
      });
    }
  }, {
    ...
    value: function renderLabelLineItem(option, props) {
      if (/* @__PURE__ */ import_react34.default.isValidElement(option)) {
        return /* @__PURE__ */ import_react34.default.cloneElement(option, props);
      }
      ...
      return /* @__PURE__ */ import_react34.default.createElement(Curve, _extends21({}, props, {
        type: "linear",
        className
      }));
    }
    ...
    value: function renderLabelItem(option, props, value) {
      ...
      if ((0, import_isFunction12.default)(option)) {
        label = option(props);
        if (/* @__PURE__ */ import_react34.default.isValidElement(label)) {
          return label;
        }
      }
      ...
      return /* @__PURE__ */ import_react34.default.createElement(Text2, _extends21({}, props, {
...
_Pie = Pie;
_defineProperty26(Pie, "displayName", "Pie");
_defineProperty26(Pie, "defaultProps", {
  stroke: "#fff",
  fill: "#808080",
  legendType: "rect",
  cx: "50%",
...
_defineProperty26(Pie, "parseDeltaAngle", function(startAngle, endAngle) {
  var sign2 = mathSign(endAngle - startAngle);
  var deltaAngle = Math.min(Math.abs(endAngle - startAngle), 360);
  return sign2 * deltaAngle;
});
_defineProperty26(Pie, "getRealPieData", function(item) {
  ...
  if (data && data.length) {
    return data.map(function(entry, index) {
      return _objectSpread25(_objectSpread25(_objectSpread25({
        payload: entry
  ...
  if (cells && cells.length) {
    return cells.map(function(cell) {
      return _objectSpread25(_objectSpread25({}, presentationProps), cell.props);
    });
  }
  return [];
});
_defineProperty26(Pie, "parseCoordinateOfPie", function(item, offset) {
...
_defineProperty26(Pie, "getComposedData", function(_ref4) {
  ...
  if (sum > 0) {
    ...
    sectors = pieData.map(function(entry, i) {
      ...
      prev = _objectSpread25(_objectSpread25(_objectSpread25({
        percent,
        cornerRadius,
        name,
        tooltipPayload,
  ...
  return _objectSpread25(_objectSpread25({}, coordinate), {}, {
    sectors,
    data: pieData
  });
});
...
var Brush = /* @__PURE__ */ function(_PureComponent) {
  ...
  function Brush2(props) {
    ...
    _defineProperty28(_assertThisInitialized11(_this), "handleDrag", function(e) {
      if (_this.leaveTimer) {
    ...
    _defineProperty28(_assertThisInitialized11(_this), "handleTouchMove", function(e) {
      if (e.changedTouches != null && e.changedTouches.length > 0) {
        _this.handleDrag(e.changedTouches[0]);
      }
    });
    _defineProperty28(_assertThisInitialized11(_this), "handleDragEnd", function() {
      _this.setState({
        isTravellerMoving: false,
        isSlideMoving: false
      }, function() {
    ...
    _defineProperty28(_assertThisInitialized11(_this), "handleLeaveWrapper", function() {
      if (_this.state.isTravellerMoving || _this.state.isSlideMoving) {
        _this.leaveTimer = window.setTimeout(_this.handleDragEnd, _this.props.leaveTimeOut);
      }
    });
    _defineProperty28(_assertThisInitialized11(_this), "handleEnterSlideOrTraveller", function() {
      _this.setState({
        isTextActive: true
      });
    });
    _defineProperty28(_assertThisInitialized11(_this), "handleLeaveSlideOrTraveller", function() {
      _this.setState({
        isTextActive: false
      });
    });
    _defineProperty28(_assertThisInitialized11(_this), "handleSlideDragStart", function(e) {
  ...
  _createClass11(Brush2, [{
    ...
    value: function renderTravellerLayer(travellerX, id) {
      ...
      var travellerProps = _objectSpread27(_objectSpread27({}, filterProps(this.props, false)), {}, {
        x: x2,
        y: y2,
    ...
    value: function renderText() {
      ...
      }, /* @__PURE__ */ import_react35.default.createElement(Text2, _extends22({
        textAnchor: "end",
        verticalAnchor: "middle",
        x: Math.min(startX, endX) - offset,
        y: y2 + height / 2
      }, attrs), this.getTextOfTick(startIndex)), /* @__PURE__ */ import_react35.default.createElement(Text2, _extends22({
        textAnchor: "start",
        verticalAnchor: "middle",
...
var ScaleHelper = /* @__PURE__ */ function() {
  function ScaleHelper2(scale) {
    _classCallCheck12(this, ScaleHelper2);
    this.scale = scale;
  }
  _createClass12(ScaleHelper2, [{
    key: "domain",
    get: function get7() {
...
var renderLine = function renderLine2(option, props) {
  ...
  if (/* @__PURE__ */ import_react37.default.isValidElement(option)) {
    ...
    line = /* @__PURE__ */ import_react37.default.createElement("line", _extends23({}, props, {
...
ReferenceDot.renderDot = function(option, props) {
  ...
  if (/* @__PURE__ */ import_react38.default.isValidElement(option)) {
    ...
    dot = /* @__PURE__ */ import_react38.default.createElement(Dot, _extends24({}, props, {
      cx: props.cx,
      cy: props.cy,
...
ReferenceArea.renderRect = function(option, props) {
  ...
  if (/* @__PURE__ */ import_react39.default.isValidElement(option)) {
    ...
    rect = /* @__PURE__ */ import_react39.default.createElement(Rectangle, _extends25({}, props, {
...
function Cursor(props) {
  ...
  var cursorProps = _objectSpread32(_objectSpread32(_objectSpread32(_objectSpread32({
    stroke: "#ccc",
    pointerEvents: "none"
  ...
  return /* @__PURE__ */ (0, import_react40.isValidElement)(element.props.cursor) ? /* @__PURE__ */ (0, import_react40.cloneElement)(element.props.cursor, cursorProps) : /* @__PURE__ */ (0, import_react40.createElement)(cursorComp, cursorProps);
}
...
var getActiveCoordinate = function getActiveCoordinate2(layout, tooltipTicks, activeIndex, rangeObj) {
  ...
  if (entry) {
    ...
    if (layout === "centric") {
      ...
      return _objectSpread33(_objectSpread33(_objectSpread33({}, rangeObj), polarToCartesian(rangeObj.cx, rangeObj.cy, _radius, _angle)), {}, {
        angle: _angle,
        radius: _radius
      });
    }
    ...
    return _objectSpread33(_objectSpread33(_objectSpread33({}, rangeObj), polarToCartesian(rangeObj.cx, rangeObj.cy, radius, angle)), {}, {
      angle,
      radius
    });
  }
...
var getAxisMapByAxes = function getAxisMapByAxes2(props, _ref2) {
  ...
  return axes.reduce(function(result, child) {
      ...
      if (dataKey) {
        ...
        if (type === "category" && isCategorical) {
          ...
          if (!allowDuplicatedCategory) {
            domain = parseDomainOfCategoryAxis(childDomain, domain, child).reduce(function(finalDomain, entry) {
              return finalDomain.indexOf(entry) >= 0 || entry === "" || (0, import_isNil9.default)(entry) ? finalDomain : [].concat(_toConsumableArray11(finalDomain), [entry]);
            }, []);
          } else {
    ...
    return _objectSpread33(_objectSpread33({}, result), {}, _defineProperty35({}, axisId, _objectSpread33(_objectSpread33({}, child.props), {}, {
      axisType,
      domain,
      categoricalDomain,
      duplicateDomain,
...
var getAxisMapByItems = function getAxisMapByItems2(props, _ref3) {
  ...
  return graphicalItems.reduce(function(result, child) {
    ...
    if (!result[axisId]) {
      ...
      return _objectSpread33(_objectSpread33({}, result), {}, _defineProperty35({}, axisId, _objectSpread33(_objectSpread33({
        axisType
      }, Axis.defaultProps), {}, {
        hide: true,
...
var calculateOffset = function calculateOffset2(_ref5, prevLegendBBox) {
  ...
  var offsetH = Object.keys(yAxisMap).reduce(function(result, id) {
    ...
    if (!entry.mirror && !entry.hide) {
      return _objectSpread33(_objectSpread33({}, result), {}, _defineProperty35({}, orientation, result[orientation] + entry.width));
    }
    return result;
  }, {
    left: margin.left || 0,
  ...
  var offsetV = Object.keys(xAxisMap).reduce(function(result, id) {
    ...
    var orientation = entry.orientation;
    if (!entry.mirror && !entry.hide) {
      return _objectSpread33(_objectSpread33({}, result), {}, _defineProperty35({}, orientation, (0, import_get5.default)(result, "".concat(orientation)) + entry.height));
    }
    return result;
  }, {
    top: margin.top || 0,
  ...
  var offset = _objectSpread33(_objectSpread33({}, offsetV), offsetH);
...
var generateCategoricalChart = function generateCategoricalChart2(_ref6) {
  ...
  var getFormatItems = function getFormatItems2(props, currentState) {
    ...
    graphicalItems.forEach(function(item, index) {
      ...
      var axisObj = axisComponents.reduce(function(result, entry) {
        ...
        var axis = axisMap[id];
        return _objectSpread33(_objectSpread33({}, result), {}, _defineProperty35(_defineProperty35({}, entry.axisType, axis), "".concat(entry.axisType, "Ticks"), getTicksOfAxis(axis)));
      }, axisObjInitialValue);
      ...
      if (itemIsBar) {
        ...
        if (barBandSize !== bandSize) {
          barPosition = barPosition.map(function(pos) {
            return _objectSpread33(_objectSpread33({}, pos), {}, {
              position: _objectSpread33(_objectSpread33({}, pos.position), {}, {
      ...
      if (composedFn) {
        formattedItems.push({
          props: _objectSpread33(_objectSpread33({}, composedFn(_objectSpread33(_objectSpread33({}, axisObj), {}, {
            displayedData,
            props,
            dataKey,
            item,
            ...
            dataStartIndex,
            dataEndIndex
          }))), {}, _defineProperty35(_defineProperty35(_defineProperty35({
  ...
  var updateStateOfAxisMapsOffsetAndStackGroups = function updateStateOfAxisMapsOffsetAndStackGroups2(_ref8, prevState) {
    ...
    var axisObj = axisComponents.reduce(function(result, entry) {
      ...
      return _objectSpread33(_objectSpread33({}, result), {}, _defineProperty35({}, name, getAxisMap(props, _objectSpread33(_objectSpread33({}, entry), {}, {
        graphicalItems,
    ...
    var offset = calculateOffset(_objectSpread33(_objectSpread33({}, axisObj), {}, {
      props,
      graphicalItems
    ...
    var formattedGraphicalItems = getFormatItems(props, _objectSpread33(_objectSpread33({}, axisObj), {}, {
      dataStartIndex,
      dataEndIndex,
      updateId,
      graphicalItems,
  ...
  return _CategoricalChartWrapper = /* @__PURE__ */ function(_Component) {
    ...
    function CategoricalChartWrapper(_props) {
      ...
      _defineProperty35(_assertThisInitialized12(_this), "eventEmitterSymbol", Symbol("rechartsEventEmitter"));
      _defineProperty35(_assertThisInitialized12(_this), "accessibilityManager", new AccessibilityManager());
      _defineProperty35(_assertThisInitialized12(_this), "handleLegendBBoxUpdate", function(box) {
        if (box) {
          var _this$state = _this.state, dataStartIndex = _this$state.dataStartIndex, dataEndIndex = _this$state.dataEndIndex, updateId = _this$state.updateId;
          _this.setState(_objectSpread33({
            legendBBox: box
            ...
            dataEndIndex,
            updateId
          }, _objectSpread33(_objectSpread33({}, _this.state), {}, {
            legendBBox: box
          }))));
        }
      });
      _defineProperty35(_assertThisInitialized12(_this), "handleReceiveSyncEvent", function(cId, data, emitter) {
      ...
      _defineProperty35(_assertThisInitialized12(_this), "handleBrushChange", function(_ref9) {
      ...
      _defineProperty35(_assertThisInitialized12(_this), "handleMouseEnter", function(e) {
        var mouse = _this.getMouseInfo(e);
        if (mouse) {
          var _nextState = _objectSpread33(_objectSpread33({}, mouse), {}, {
      ...
      _defineProperty35(_assertThisInitialized12(_this), "triggeredAfterMouseMove", function(e) {
        var mouse = _this.getMouseInfo(e);
        var nextState = mouse ? _objectSpread33(_objectSpread33({}, mouse), {}, {
          isTooltipActive: true
        }) : {
      ...
      _defineProperty35(_assertThisInitialized12(_this), "handleItemMouseEnter", function(el) {
        _this.setState(function() {
          return {
            isTooltipActive: true,
            activeItem: el,
      ...
      _defineProperty35(_assertThisInitialized12(_this), "handleItemMouseLeave", function() {
        _this.setState(function() {
          return {
            isTooltipActive: false
          };
      ...
      _defineProperty35(_assertThisInitialized12(_this), "handleMouseMove", function(e) {
        e.persist();
        _this.throttleTriggeredAfterMouseMove(e);
      });
      _defineProperty35(_assertThisInitialized12(_this), "handleMouseLeave", function(e) {
      ...
      _defineProperty35(_assertThisInitialized12(_this), "handleOuterEvent", function(e) {
      ...
      _defineProperty35(_assertThisInitialized12(_this), "handleClick", function(e) {
        var mouse = _this.getMouseInfo(e);
        if (mouse) {
          var _nextState2 = _objectSpread33(_objectSpread33({}, mouse), {}, {
            isTooltipActive: true
          });
      ...
      _defineProperty35(_assertThisInitialized12(_this), "handleMouseDown", function(e) {
      ...
      _defineProperty35(_assertThisInitialized12(_this), "handleMouseUp", function(e) {
      ...
      _defineProperty35(_assertThisInitialized12(_this), "handleTouchMove", function(e) {
        if (e.changedTouches != null && e.changedTouches.length > 0) {
          _this.throttleTriggeredAfterMouseMove(e.changedTouches[0]);
        }
      });
      _defineProperty35(_assertThisInitialized12(_this), "handleTouchStart", function(e) {
        if (e.changedTouches != null && e.changedTouches.length > 0) {
          _this.handleMouseDown(e.changedTouches[0]);
        }
      });
      _defineProperty35(_assertThisInitialized12(_this), "handleTouchEnd", function(e) {
        if (e.changedTouches != null && e.changedTouches.length > 0) {
          _this.handleMouseUp(e.changedTouches[0]);
        }
      });
      _defineProperty35(_assertThisInitialized12(_this), "triggerSyncEvent", function(data) {
        if (_this.props.syncId !== void 0) {
          eventCenter.emit(SYNC_EVENT, _this.props.syncId, data, _this.eventEmitterSymbol);
        }
      });
      _defineProperty35(_assertThisInitialized12(_this), "applySyncEvent", function(data) {
        ...
        if (data.dataStartIndex !== void 0 || data.dataEndIndex !== void 0) {
          ...
          var viewBox = _objectSpread33(_objectSpread33({}, offset), {}, {
            x: offset.left,
            y: offset.top
          });
          ...
          _this.setState(_objectSpread33(_objectSpread33({}, data), {}, {
            activeLabel,
            activeCoordinate,
            activePayload,
            activeTooltipIndex
      ...
      _defineProperty35(_assertThisInitialized12(_this), "renderCursor", function(element) {
      ...
      _defineProperty35(_assertThisInitialized12(_this), "renderPolarAxis", function(element, displayName, index) {
        ...
        return /* @__PURE__ */ (0, import_react41.cloneElement)(element, _objectSpread33(_objectSpread33({}, axisOption), {}, {
          className: clsx_default(axisType, axisOption.className),
          key: element.key || "".concat(displayName, "-").concat(index),
          ticks: getTicksOfAxis(axisOption, true)
        }));
      });
      _defineProperty35(_assertThisInitialized12(_this), "renderPolarGrid", function(element) {
      ...
      _defineProperty35(_assertThisInitialized12(_this), "renderLegend", function() {
        ...
        return /* @__PURE__ */ (0, import_react41.cloneElement)(item, _objectSpread33(_objectSpread33({}, otherProps), {}, {
          chartWidth: width,
          chartHeight: height,
          margin,
      ...
      _defineProperty35(_assertThisInitialized12(_this), "renderTooltip", function() {
        ...
        return /* @__PURE__ */ (0, import_react41.cloneElement)(tooltipItem, {
          viewBox: _objectSpread33(_objectSpread33({}, offset), {}, {
            x: offset.left,
            y: offset.top
          }),
          active: isActive,
      ...
      _defineProperty35(_assertThisInitialized12(_this), "renderBrush", function(element) {
      ...
      _defineProperty35(_assertThisInitialized12(_this), "renderReferenceElement", function(element, displayName, index) {
        if (!element) {
          return null;
        }
      ...
      _defineProperty35(_assertThisInitialized12(_this), "renderActivePoints", function(_ref10) {
        ...
        if (basePoint) {
          result.push(CategoricalChartWrapper.renderActiveDot(activeDot, _objectSpread33(_objectSpread33({}, dotProps), {}, {
            cx: basePoint.x,
            cy: basePoint.y,
      ...
      _defineProperty35(_assertThisInitialized12(_this), "renderGraphicChild", function(element, displayName, index) {
        ...
        var graphicalItem = /* @__PURE__ */ (0, import_react41.cloneElement)(element, _objectSpread33(_objectSpread33({}, item.props), itemEvents));
        ...
        if (hasActive) {
          if (activeTooltipIndex >= 0) {
            ...
            if (activeShape || activeBar) {
              ...
              return [/* @__PURE__ */ (0, import_react41.cloneElement)(element, _objectSpread33(_objectSpread33(_objectSpread33({}, item.props), itemEvents), {}, {
                activeIndex
              })), null, null];
            }
            ...
            var elementProps = _objectSpread33(_objectSpread33(_objectSpread33({}, item.props), itemEvents), {}, {
      ...
      _defineProperty35(_assertThisInitialized12(_this), "renderCustomized", function(element, displayName, index) {
        return /* @__PURE__ */ (0, import_react41.cloneElement)(element, _objectSpread33(_objectSpread33({
          key: "recharts-customized-".concat(index)
        }, _this.props), _this.state));
      });
      _defineProperty35(_assertThisInitialized12(_this), "renderMap", {
        CartesianGrid: {
          handler: renderAsIs,
          once: true
        },
    ...
    _createClass14(CategoricalChartWrapper, [{
      ...
      value: function displayDefaultTooltip() {
        ...
        if (scatterPlotElement) {
          activeCoordinate = _objectSpread33(_objectSpread33({}, activeCoordinate), scatterPlotElement.props.points[defaultIndex].tooltipPosition);
      ...
      value: function getMouseInfo(event) {
        ...
        if (tooltipEventType !== "axis" && xAxisMap && yAxisMap) {
          ...
          return _objectSpread33(_objectSpread33({}, e), {}, {
            xValue,
            yValue
          });
        }
        ...
        if (toolTipData) {
          return _objectSpread33(_objectSpread33({}, e), toolTipData);
        }
        return null;
      }
    }, {
      ...
      value: function parseEventsOfWrapper() {
        ...
        return _objectSpread33(_objectSpread33({}, outerEvents), tooltipEvents);
      }
    }, {
      key: "addListener",
      ...
      value: function getXScales() {
        ...
        return xAxisMap ? Object.entries(xAxisMap).reduce(function(res, _ref13) {
          ...
          return _objectSpread33(_objectSpread33({}, res), {}, _defineProperty35({}, axisId, axisProps.scale));
        }, {}) : null;
      }
    }, {
      key: "getYScales",
        ...
        if (formattedGraphicalItems && formattedGraphicalItems.length) {
          for (var i = 0, len = formattedGraphicalItems.length; i < len; i++) {
            ...
            if (itemDisplayName === "Bar") {
              ...
              return {
                graphicalItem: _objectSpread33(_objectSpread33({}, graphicalItem), {}, {
                  childIndex
                }),
      ...
      value: function render() {
        ...
        if (compact) {
          ...
          }, /* @__PURE__ */ import_react41.default.createElement(Surface, _extends26({}, attrs, {
            width,
            height,
            title,
            desc
        ...
        return /* @__PURE__ */ import_react41.default.createElement(ChartLayoutContextProvider, {
          ...
          height: this.props.height,
          clipPathId: this.clipPathId
        }, /* @__PURE__ */ import_react41.default.createElement("div", _extends26({
          className: clsx_default("recharts-wrapper", className),
          style: _objectSpread33({
            position: "relative",
            cursor: "default",
            width,
            height
  ...
  }(import_react41.Component), _defineProperty35(_CategoricalChartWrapper, "displayName", chartName), _defineProperty35(_CategoricalChartWrapper, "defaultProps", _objectSpread33({
    layout: "horizontal",
    stackOffset: "none",
    barCategoryGap: "10%",
    barGap: 4,
    ...
    syncMethod: "index"
  }, defaultProps5)), _defineProperty35(_CategoricalChartWrapper, "getDerivedStateFromProps", function(nextProps, prevState) {
    var dataKey = nextProps.dataKey, data = nextProps.data, children = nextProps.children, width = nextProps.width, height = nextProps.height, layout = nextProps.layout, stackOffset = nextProps.stackOffset, margin = nextProps.margin;
    var dataStartIndex = prevState.dataStartIndex, dataEndIndex = prevState.dataEndIndex;
    if (prevState.updateId === void 0) {
      var defaultState = createDefaultState(nextProps);
      return _objectSpread33(_objectSpread33(_objectSpread33({}, defaultState), {}, {
        updateId: 0
      }, updateStateOfAxisMapsOffsetAndStackGroups(_objectSpread33(_objectSpread33({
        props: nextProps
      }, defaultState), {}, {
        updateId: 0
      }), prevState)), {}, {
    ...
    if (dataKey !== prevState.prevDataKey || data !== prevState.prevData || width !== prevState.prevWidth || height !== prevState.prevHeight || layout !== prevState.prevLayout || stackOffset !== prevState.prevStackOffset || !shallowEqual(margin, prevState.prevMargin)) {
      ...
      var updatesToState = _objectSpread33(_objectSpread33({}, getTooltipData(prevState, data, layout)), {}, {
        updateId: prevState.updateId + 1
      });
      var newState = _objectSpread33(_objectSpread33(_objectSpread33({}, _defaultState), keepFromPrevState), updatesToState);
      return _objectSpread33(_objectSpread33(_objectSpread33({}, newState), updateStateOfAxisMapsOffsetAndStackGroups(_objectSpread33({
        props: nextProps
      }, newState), prevState)), {}, {
        prevDataKey: dataKey,
        prevData: data,
    ...
    return null;
  }), _defineProperty35(_CategoricalChartWrapper, "renderActiveDot", function(option, props) {
    var dot;
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/components/budgets/budgetsChart.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1733598066446.1157";
}
var BudgetsChart = ({
  budgets
}) => {
  ...
  const overallSpent = (0, import_react42.useMemo)(() => {
    return budgets.reduce((sum, budget) => sum + budget.totalSpent, 0);
  }, [budgets]);
  const overallMaxLimit = (0, import_react42.useMemo)(() => {
    return budgets.reduce((sum, budget) => sum + budget.maxSpend, 0);
  }, [budgets]);
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Flex, { position: "relative", maxW: "15rem", maxH: "15rem", direction: "column", justify: "center", align: "center", gap: "0.5rem", flex: "1 0 0", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(PieChart, { width: 240, height: 240, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Pie, { data, cx: "50%", cy: "50%", innerRadius: 80, outerRadius: 120, fill: "#8884d8", stroke: "none", dataKey: "totalSpent", startAngle: 90, endAngle: -270, style: {
      outline: "none"
    }, rootTabIndex: -1, children: data && data.length > 0 && data.map((entry, index) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Cell, { fill: entry.color }, `cell-${index}`, false, {
      fileName: "app/components/budgets/budgetsChart.tsx",
      lineNumber: 49,
      columnNumber: 76
    }, this)) }, void 0, false, {
      fileName: "app/components/budgets/budgetsChart.tsx",
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Box, { position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", display: "inline-flex", flexDirection: "column", alignItems: "center", gap: theme_default.spacing[100], children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Text, { textStyle: "preset1", color: "grey.900", children: [
        "$",
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Text, { textStyle: "preset4", color: "grey.500", children: [
        "of $",
        overallMaxLimit,
        " limit"
      ] }, void 0, true, {
...
_s(BudgetsChart, "vxpzYx0nIhUXE8hplOwHwaKa9HY=");
_c = BudgetsChart;
var budgetsChart_default = BudgetsChart;
var _c;
$RefreshReg$(_c, "BudgetsChart");
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/components/dashboard/summaryTitle.tsx"' + id);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
var SummaryTitle = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Flex, { align: "center", justify: "space-between", alignSelf: "stretch", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Text, { textStyle: titleStyle, color: "grey.900", children: title }, void 0, false, {
      fileName: "app/components/dashboard/summaryTitle.tsx",
      lineNumber: 32,
      columnNumber: 13
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Link2, { to: link, as: Link, state: {
      fromLink: true
    }, _hover: {
      textDecoration: "none"
      ...
      lineNumber: 40,
      columnNumber: 79
    }, this), tabIndex: -1, children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Text, { textStyle: "preset4", fontWeight: "400", children: linkText }, void 0, false, {
      fileName: "app/components/dashboard/summaryTitle.tsx",
      lineNumber: 41,
      columnNumber: 21
    }, this) }, void 0, false, {
...
_c2 = SummaryTitle;
var summaryTitle_default = SummaryTitle;
var _c2;
