...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/components/ui/inputField.tsx"' + id);
  };
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(InputGroup, { children: [
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Input, { maxLength, sx: {
            display: "flex",
            padding: `${theme_default.spacing[150]} ${theme_default.spacing[250]}`,
            alignItems: "center",
            gap: `${theme_default.spacing[200]}`,
            borderRadius: `${theme_default.spacing[100]}`,
            border: "1px solid #98908B",
            bg: "white",
            flex: "1 0 0",
            outline: "none",
            fontSize: "0.875rem",
            pl: prefix ? "2.5rem" : theme_default.spacing[150]
          }, _placeholder: {
            color: "beige.500",
            textStyle: "preset4"
          }, _hover: {
...
_s(InputField, "8TmYsf1/coLz/ZTGcaeK/xQwVg8=");
_c = InputField;
...
(function() {
  ...
  function D2(f, a) {
    ...
    if (C2(f))
      return new H(w, w);
    if (B(f))
      return a = D2(x(f), a), new H(x(a.g), x(a.h));
    if (B(a))
      return a = D2(f, x(a)), new H(x(a.g), a.h);
    if (30 < f.g.length) {
      if (B(f) || B(a))
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1733604086002.3625";
}
var firebaseConfig = {
...
var doSignInWithEmailAndPassword = (email, password) => {
